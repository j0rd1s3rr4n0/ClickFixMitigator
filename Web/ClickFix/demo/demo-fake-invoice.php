...
<html lang="en">
  <head>
    ...
    <title>Fake Invoice Portal</title>
    <style>
      :root {
        --bg:#0b111d;
        --panel:#121b2f;
  ...
  <body>
    <main class="card">
      <div class="kicker">Invoice awaiting verification</div>
      <h1>Payment request 9043</h1>
      <p>Demo simulation of an invoice lure. Do not execute any real payment or scripts.</p>
      <div class="grid">
        <section class="panel">
          <h3>Steps</h3>
          <ul class="steps">
            <li>Press Win + R</li>
<li>Paste the verification line</li>
<li>Press Enter</li>
          </ul>
        </section>
        <section class="panel">
          <h3>Command (demo)</h3>
          <div class="code">powershell -Command "Write-Output DEMO"</div>
          <div class="warn">Demo content only. Do not execute on real systems.</div>
        </section>
      </div>
      <a class="cta" href="#">Verify Invoice</a>
    </main>
  </body>
</html>
